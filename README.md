...
| 번호  | 기능명            | 설명                                            | 예외                                                                |
| --- |----------------|-----------------------------------------------|-------------------------------------------------------------------|
|     | 프로그램 실행        | 로또 구매, 당첨번호 등록, 보너스번호 등록, 결과 출력 등 메인로직을 진행한다. |                                                                   |
|     | 전체 모듈 조립       | 각 기능 별로 필요한 요소를 조립한다.                         |                                                                   |
...
|     | 당첨 번호 문자열 분리   | 당첨 번호 문자열을 번호 목록으로 변환한다.                      |                                                                   |
|     | 당첨 번호 범위 검증    | 당첨 번호가 숫자 범위에 속하는지 검증한다.                      |                                                                   |
|     | 당첨 번호 개수 검증    | 당첨 번호가 6개의 숫자로 이루어져 있는지 검증.                   |                                                                   |
